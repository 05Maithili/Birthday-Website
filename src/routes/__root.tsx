...
function Navbar() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-4 py-4 md:px-8">
      <nav className="mx-auto max-w-6xl rounded-full border border-white/10 bg-black/40 backdrop-blur-md px-6 py-3 shadow-[0_0_15px_rgba(253,186,116,0.08)] hover:shadow-[0_0_25px_rgba(253,186,116,0.15)] transition-all duration-300">
        <div className="flex items-center justify-between">
          {/* Logo / Brand */}
          <Link to="/" className="flex items-center gap-2 group">
            <Guitar className="h-5 w-5 text-[color:var(--gold)] transition-transform duration-300 group-hover:rotate-12" />
            <span className="font-display font-bold tracking-wider text-sm md:text-base text-gold-gradient">
              Vineet's Birthday
            </span>
          </Link>
